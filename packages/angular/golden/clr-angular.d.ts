...
export declare class ClrDateContainer implements DynamicWrapper, OnDestroy, AfterViewInit, AfterContentInit {
    ...
    ngOnDestroy(): void;
    ngOnInit(): void;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<ClrDateContainer, "clr-date-container", never, { "clrPosition": "clrPosition"; }, {}, ["label", "controlSuccessComponent", "controlErrorComponent", "controlHelperComponent"], ["label", "[clrDate]", "clr-control-helper", "clr-control-error", "clr-control-success"]>;
